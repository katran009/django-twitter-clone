...
from twitteruser.models import Post, Comment
...
class PostListView(LoginRequiredMixin, ListView):
    model = Post
    template_name = 'twitteruser/home.html'
    context_object_name = 'posts'
    ordering = ['-date_posted']d
...
class UserPostListView(LoginRequiredMixin, ListView):
    model = Post
    template_name = 'twitteruser/user_posts.html'
    context_object_name = 'posts'
    paginate_by = PAGINATION_COUNT
...
class PostDetailView(DetailView):
    model = Post
    template_name = 'twitteruser/post_detail.html'
...
class PostDeleteView(LoginRequiredMixin, UserPassesTestMixin, DeleteView):
    model = Post
    template_name = 'twitteruser/post_delete.html'
    context_object_name = 'post'
    success_url = '/'
...
class PostCreateView(LoginRequiredMixin, CreateView):
    model = Post
    fields = ['content']
    template_name = 'twitteruser/post_new.html'
    success_url = '/'
...
class FollowsListView(ListView):
    model = Follow
    template_name = 'twitteruser/follow.html'
